...
void sendData () {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 60000 || sendDataPrevMillis == 0)){
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/moisture1", moistAdc[0])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/moisture2", moistAdc[1])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/moisture3", moistAdc[2])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/" + dateLog + "/humidity", h)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/" + dateLog + "/temperature", t)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/" + dateLog + "/moisture1", moistAdc[0])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/" + dateLog + "/moisture2", moistAdc[1])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "test/" + dateLog + "/moisture3", moistAdc[2])){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
...
void printLocalTime(){
  ...
  char dateBuffer[20];
  strftime(dateBuffer,20, "%d-%B-%Y", &timeinfo);
