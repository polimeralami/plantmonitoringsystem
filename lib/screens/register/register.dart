...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    super.initState();
    emailController.text = "randy.ferdian.cg@gmail.com";
  ...
  Future<bool> registerUser() async {
    bool response = await context.read<FirebaseAuthMethods>().signUpWithEmail(
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  if (success) {
                                    await showMyDialog(context, "Verify Email",
                                        "Please check your inbox and verify you email address");
